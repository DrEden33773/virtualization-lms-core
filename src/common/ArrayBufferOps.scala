...
trait ArrayBufferOps extends Base with StringOps with ArrayOps {
  ...
  implicit def repToArrayBufferOps[A: Typ](l: Rep[ArrayBuffer[A]]) =
    new ArrayBufferOpsCls(l)

  class ArrayBufferOpsCls[A: Typ](l: Rep[ArrayBuffer[A]]) {
    def +=(e: Rep[A])(implicit pos: SourceContext) = arraybuffer_append(l, e)
    def ++=(e: Rep[Array[A]])(implicit pos: SourceContext) =
      arraybuffer_append_array(l, e)
    def ++=(e: Rep[Seq[A]])(implicit o: Overloaded1, pos: SourceContext) =
      arraybuffer_append_seq(l, e)
    def mkString(sep: Rep[String] = unit(""))(implicit pos: SourceContext) =
      arraybuffer_mkstring(l, sep)
    def append(e: Rep[A])(implicit pos: SourceContext) =
      arraybuffer_append(l, e)
    def appendAll(e: Rep[Array[A]])(implicit pos: SourceContext) =
      arraybuffer_append_array(l, e)
    def appendAll(e: Rep[Seq[A]])(implicit o: Overloaded1, pos: SourceContext) =
      arraybuffer_append_seq(l, e)
  ...
  def infix_+=[A: Typ](l: Rep[ArrayBuffer[A]], e: Rep[A])(implicit
      pos: SourceContext
  ) = arraybuffer_append(l, e)
  ...
  def arraybuffer_mkstring[A: Typ](l: Rep[ArrayBuffer[A]], sep: Rep[String])(
      implicit pos: SourceContext
  ): Rep[String]
  def arraybuffer_append[A: Typ](l: Rep[ArrayBuffer[A]], e: Rep[A])(implicit
      pos: SourceContext
  ): Rep[Unit]
  def arraybuffer_append_array[A: Typ](
      l: Rep[ArrayBuffer[A]],
      e: Rep[Array[A]]
  )(implicit pos: SourceContext): Rep[Unit]
  def arraybuffer_append_seq[A: Typ](l: Rep[ArrayBuffer[A]], e: Rep[Seq[A]])(
      implicit pos: SourceContext
  ): Rep[Unit]
  def arraybuffer_new[A: Typ](xs: Seq[Rep[A]])(implicit
      pos: SourceContext
  ): Rep[ArrayBuffer[A]]
  def arraybuffer_clear[A: Typ](l: Rep[ArrayBuffer[A]]): Rep[Unit]
  def arraybuffer_toarray[A: Typ](x: Rep[ArrayBuffer[A]])(implicit
      pos: SourceContext
  ): Rep[Array[A]]
  def arraybuffer_toseq[A: Typ](x: Rep[ArrayBuffer[A]])(implicit
      pos: SourceContext
  ): Rep[Seq[A]]
}
...
trait ArrayBufferOpsExp extends ArrayBufferOps with EffectExp {
  ...
  case class ArrayBufferNew[A: Typ](xs: Seq[Exp[A]])
      extends Def[ArrayBuffer[A]] {
    def mA = typ[A]
  }
  case class ArrayBufferMkString[A: Typ](
      l: Exp[ArrayBuffer[A]],
      sep: Exp[String]
  ) extends Def[String]
  case class ArrayBufferAppend[A: Typ](l: Exp[ArrayBuffer[A]], e: Exp[A])
      extends Def[Unit]
  case class ArrayBufferAppendArray[A: Typ](
      l: Exp[ArrayBuffer[A]],
      e: Exp[Array[A]]
  ) extends Def[Unit]
  case class ArrayBufferAppendSeq[A: Typ](
      l: Exp[ArrayBuffer[A]],
      e: Exp[Seq[A]]
  ) extends Def[Unit]
  case class ArrayBufferClear[A: Typ](l: Exp[ArrayBuffer[A]]) extends Def[Unit]
  case class ArrayBufferToArray[A: Typ](x: Exp[ArrayBuffer[A]])
      extends Def[Array[A]]
  case class ArrayBufferToSeq[A: Typ](x: Exp[ArrayBuffer[A]])
      extends Def[Seq[A]]

  def arraybuffer_new[A: Typ](xs: Seq[Exp[A]])(implicit pos: SourceContext) =
    reflectMutable(ArrayBufferNew(xs))
  def arraybuffer_mkstring[A: Typ](l: Exp[ArrayBuffer[A]], sep: Exp[String])(
      implicit pos: SourceContext
  ) = ArrayBufferMkString(l, sep)
  def arraybuffer_append[A: Typ](l: Exp[ArrayBuffer[A]], e: Exp[A])(implicit
      pos: SourceContext
  ) = reflectWrite(l)(ArrayBufferAppend(l, e))
  def arraybuffer_append_array[A: Typ](
      l: Rep[ArrayBuffer[A]],
      e: Rep[Array[A]]
  )(implicit pos: SourceContext): Rep[Unit] =
    reflectWrite(l)(ArrayBufferAppendArray(l, e))
  def arraybuffer_append_seq[A: Typ](l: Rep[ArrayBuffer[A]], e: Rep[Seq[A]])(
      implicit pos: SourceContext
  ): Rep[Unit] = reflectWrite(l)(ArrayBufferAppendSeq(l, e))
  def arraybuffer_clear[A: Typ](l: Exp[ArrayBuffer[A]]) =
    reflectWrite(l)(ArrayBufferClear(l))
  def arraybuffer_toarray[A: Typ](x: Exp[ArrayBuffer[A]])(implicit
      pos: SourceContext
  ) = ArrayBufferToArray(x)
  def arraybuffer_toseq[A: Typ](x: Exp[ArrayBuffer[A]])(implicit
      pos: SourceContext
  ) = ArrayBufferToSeq(x)
  ...
  override def mirrorDef[A: Typ](e: Def[A], f: Transformer)(implicit
    ...
    case ArrayBufferAppendArray(l, r) =>
      ArrayBufferAppendArray(f(l), f(r))(mtyp1[A])
    case ArrayBufferAppendSeq(l, r) =>
      ArrayBufferAppendSeq(f(l), f(r))(mtyp1[A])
...
trait ScalaGenArrayBufferOps extends BaseGenArrayBufferOps with ScalaGenEffect {
  ...
  override def emitNode(sym: Sym[Any], rhs: Def[Any]) = rhs match {
    case a @ ArrayBufferNew(xs) =>
      emitValDef(
        sym,
        src"scala.collection.mutable.ArrayBuffer[${a.mA}](${(xs map { quote }).mkString(",")})"
      )
...
trait OpenCLGenArrayBufferOps
    extends OpenCLGenEffect
    with CLikeGenArrayBufferOps
