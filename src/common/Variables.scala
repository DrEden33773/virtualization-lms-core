...
trait LiftVariables extends Base {
  ...
  def __newVar[T: Typ](init: T)(implicit pos: SourceContext) = var_new(
    unit(init)
  )
  def __newVar[T](
      init: Rep[T]
  )(implicit o: Overloaded1, mT: Typ[T], pos: SourceContext) = var_new(init)
  def __newVar[T](
      init: Var[T]
  )(implicit o: Overloaded2, mT: Typ[T], pos: SourceContext) = var_new(init)
}
...
trait ReadVarImplicitExp extends EffectExp {
  ...
  implicit def readVar[T: Typ](v: Var[T])(implicit pos: SourceContext): Exp[T] =
    ReadVar(v)
}
...
trait LowPriorityVariableImplicits extends ImplicitOps {
  ...
  implicit def varIntToRepDouble(x: Var[Int])(implicit
      pos: SourceContext
  ): Rep[Double] = implicit_convert[Int, Double](readVar(x))
  implicit def varIntToRepFloat(x: Var[Int])(implicit
      pos: SourceContext
  ): Rep[Float] = implicit_convert[Int, Float](readVar(x))
  implicit def varFloatToRepDouble(x: Var[Float])(implicit
      pos: SourceContext
  ): Rep[Double] = implicit_convert[Float, Double](readVar(x))
}
...
trait VariableImplicits extends LowPriorityVariableImplicits {
  ...
  implicit def varIntToRepInt(v: Var[Int])(implicit
      pos: SourceContext
  ): Rep[Int] = readVar(v)
  implicit def varFloatToRepFloat(v: Var[Float])(implicit
      pos: SourceContext
  ): Rep[Float] = readVar(v)
}
...
trait Variables
    extends Base
    with OverloadHack
    with VariableImplicits
    with ReadVarImplicit {
  ...
  def var_assign[T: Typ](lhs: Var[T], rhs: Rep[T])(implicit
      pos: SourceContext
  ): Rep[Unit]
  def var_plusequals[T: Typ](lhs: Var[T], rhs: Rep[T])(implicit
      pos: SourceContext
  ): Rep[Unit]
  def var_minusequals[T: Typ](lhs: Var[T], rhs: Rep[T])(implicit
      pos: SourceContext
  ): Rep[Unit]
  def var_timesequals[T: Typ](lhs: Var[T], rhs: Rep[T])(implicit
      pos: SourceContext
  ): Rep[Unit]
  def var_divideequals[T: Typ](lhs: Var[T], rhs: Rep[T])(implicit
      pos: SourceContext
  ): Rep[Unit]

  def __assign[T: Typ](lhs: Var[T], rhs: T)(implicit pos: SourceContext) =
    var_assign(lhs, unit(rhs))
  def __assign[T](lhs: Var[T], rhs: Rep[T])(implicit
      o: Overloaded1,
      mT: Typ[T],
      pos: SourceContext
  ) = var_assign(lhs, rhs)
  def __assign[T](lhs: Var[T], rhs: Var[T])(implicit
      o: Overloaded2,
      mT: Typ[T],
      pos: SourceContext
  ) = var_assign(lhs, readVar(rhs))
  /*
  ...
  def infix_+=[T](lhs: Var[T], rhs: T)(implicit
      o: Overloaded1,
      mT: Typ[T],
      pos: SourceContext
  ) = var_plusequals(lhs, unit(rhs))
  def infix_+=[T](lhs: Var[T], rhs: Rep[T])(implicit
      o: Overloaded2,
      mT: Typ[T],
      pos: SourceContext
  ) = var_plusequals(lhs, rhs)
  def infix_+=[T](lhs: Var[T], rhs: Var[T])(implicit
      o: Overloaded3,
      mT: Typ[T],
      pos: SourceContext
  ) = var_plusequals(lhs, readVar(rhs))
  def infix_-=[T](lhs: Var[T], rhs: T)(implicit
      o: Overloaded1,
      mT: Typ[T],
      pos: SourceContext
  ) = var_minusequals(lhs, unit(rhs))
  def infix_-=[T](lhs: Var[T], rhs: Rep[T])(implicit
      o: Overloaded2,
      mT: Typ[T],
      pos: SourceContext
  ) = var_minusequals(lhs, rhs)
  def infix_-=[T](lhs: Var[T], rhs: Var[T])(implicit
      o: Overloaded3,
      mT: Typ[T],
      pos: SourceContext
  ) = var_minusequals(lhs, readVar(rhs))
  def infix_*=[T](lhs: Var[T], rhs: T)(implicit
      o: Overloaded1,
      mT: Typ[T],
      pos: SourceContext
  ) = var_timesequals(lhs, unit(rhs))
  def infix_*=[T](lhs: Var[T], rhs: Rep[T])(implicit
      o: Overloaded2,
      mT: Typ[T],
      pos: SourceContext
  ) = var_timesequals(lhs, rhs)
  def infix_*=[T](lhs: Var[T], rhs: Var[T])(implicit
      o: Overloaded3,
      mT: Typ[T],
      pos: SourceContext
  ) = var_timesequals(lhs, readVar(rhs))
  def infix_/=[T](lhs: Var[T], rhs: T)(implicit
      o: Overloaded1,
      mT: Typ[T],
      pos: SourceContext
  ) = var_divideequals(lhs, unit(rhs))
  def infix_/=[T](lhs: Var[T], rhs: Rep[T])(implicit
      o: Overloaded2,
      mT: Typ[T],
      pos: SourceContext
  ) = var_divideequals(lhs, rhs)
  def infix_/=[T](lhs: Var[T], rhs: Var[T])(implicit
      o: Overloaded3,
      mT: Typ[T],
      pos: SourceContext
  ) = var_divideequals(lhs, readVar(rhs))
}
...
trait VariablesExp
  ...
  case class VarMinusEquals[T: Typ](lhs: Var[T], rhs: Exp[T])
      extends Def[Unit] {
    def m = typ[T]
  }
  case class VarTimesEquals[T: Typ](lhs: Var[T], rhs: Exp[T])
      extends Def[Unit] {
    def m = typ[T]
  }
  case class VarDivideEquals[T: Typ](lhs: Var[T], rhs: Exp[T])
      extends Def[Unit] {
    def m = typ[T]
  }
  ...
  def var_assign[T: Typ](lhs: Var[T], rhs: Exp[T])(implicit
      pos: SourceContext
  ): Exp[Unit] = {
  ...
  def var_plusequals[T: Typ](lhs: Var[T], rhs: Exp[T])(implicit
      pos: SourceContext
  ): Exp[Unit] = {
  ...
  def var_minusequals[T: Typ](lhs: Var[T], rhs: Exp[T])(implicit
      pos: SourceContext
  ): Exp[Unit] = {
  ...
  def var_timesequals[T: Typ](lhs: Var[T], rhs: Exp[T])(implicit
      pos: SourceContext
  ): Exp[Unit] = {
  ...
  def var_divideequals[T: Typ](lhs: Var[T], rhs: Exp[T])(implicit
      pos: SourceContext
  ): Exp[Unit] = {
  ...
  override def mirror[A: Typ](e: Def[A], f: Transformer)(implicit
    ...
    case Reflect(e @ NewVar(a), u, es) =>
      reflectMirrored(Reflect(NewVar(f(a))(e.m), mapOver(f, u), f(es)))(
        mtyp1[A],
        pos
      )
    case Reflect(ReadVar(Variable(a)), u, es) =>
      reflectMirrored(Reflect(ReadVar(Variable(f(a))), mapOver(f, u), f(es)))(
        mtyp1[A],
        pos
      )
    case Reflect(e @ Assign(Variable(a), b), u, es) =>
      reflectMirrored(
        Reflect(Assign(Variable(f(a)), f(b))(e.m), mapOver(f, u), f(es))
      )(mtyp1[A], pos)
    case Reflect(e @ VarPlusEquals(Variable(a), b), u, es) =>
      reflectMirrored(
        Reflect(VarPlusEquals(Variable(f(a)), f(b))(e.m), mapOver(f, u), f(es))
      )(mtyp1[A], pos)
    case Reflect(e @ VarMinusEquals(Variable(a), b), u, es) =>
      reflectMirrored(
        Reflect(VarMinusEquals(Variable(f(a)), f(b))(e.m), mapOver(f, u), f(es))
      )(mtyp1[A], pos)
    case Reflect(e @ VarTimesEquals(Variable(a), b), u, es) =>
      reflectMirrored(
        Reflect(VarTimesEquals(Variable(f(a)), f(b))(e.m), mapOver(f, u), f(es))
      )(mtyp1[A], pos)
    case Reflect(e @ VarDivideEquals(Variable(a), b), u, es) =>
      reflectMirrored(
        Reflect(
          VarDivideEquals(Variable(f(a)), f(b))(e.m),
          mapOver(f, u),
          f(es)
        )
      )(mtyp1[A], pos)
...
trait VariablesExpOpt extends VariablesExp {
  ...
  override implicit def readVar[T: Typ](
      v: Var[T]
    ...
    if (context ne null) {
      ...
      val rhs = context.reverse.collectFirst {
        ...
        case Def(Reflect(_, u, _)) if mayWrite(u, List(vs)) =>
          None // not a simple assignment
      }
  ...
  override implicit def var_assign[T: Typ](v: Var[T], e: Exp[T])(implicit
      pos: SourceContext
  ): Exp[Unit] = {
    if (context ne null) {
      // find the last modification of variable v
      ...
      context.reverse.foreach {
        case w @ Def(Reflect(NewVar(rhs: Exp[T]), _, _)) if w == vs =>
          if (rhs == e) return ()
        case Def(Reflect(Assign(`v`, rhs: Exp[T]), _, _)) =>
          if (rhs == e) return ()
        case Def(Reflect(_, u, _))
            if mayWrite(u, List(vs)) => // not a simple assignment
        case _ => // ...
      }
    }
...
trait CLikeGenVariables extends CLikeGenBase {
  ...
  override def emitNode(sym: Sym[Any], rhs: Def[Any]) = rhs match {
    ...
    case NewVar(init) =>
      emitVarDef(sym.asInstanceOf[Sym[Variable[Any]]], quote(init))
    case Assign(Variable(a), b) =>
      stream.println(quote(a) + " = " + quote(b) + ";")
    case VarPlusEquals(Variable(a), b) =>
      stream.println(quote(a) + " += " + quote(b) + ";")
    case VarMinusEquals(Variable(a), b) =>
      stream.println(quote(a) + " -= " + quote(b) + ";")
