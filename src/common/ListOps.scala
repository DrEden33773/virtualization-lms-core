...
trait ListOps extends Variables {
  ...
  implicit def varToListOps[T: Typ](x: Var[List[T]]) = new ListOpsCls(
    readVar(x)
  ) // FIXME: dep on var is not nice
  ...
  def list_new[A: Typ](xs: Seq[Rep[A]])(implicit
      pos: SourceContext
  ): Rep[List[A]]
  def list_fromseq[A: Typ](xs: Rep[Seq[A]])(implicit
      pos: SourceContext
  ): Rep[List[A]]
  def list_map[A: Typ, B: Typ](l: Rep[List[A]], f: Rep[A] => Rep[B])(implicit
      pos: SourceContext
  ): Rep[List[B]]
  def list_flatMap[A: Typ, B: Typ](xs: Rep[List[A]], f: Rep[A] => Rep[List[B]])(
      implicit pos: SourceContext
  ): Rep[List[B]]
  def list_filter[A: Typ](l: Rep[List[A]], f: Rep[A] => Rep[Boolean])(implicit
      pos: SourceContext
  ): Rep[List[A]]
  def list_sortby[A: Typ, B: Typ: Ordering](
      l: Rep[List[A]],
      f: Rep[A] => Rep[B]
  )(implicit pos: SourceContext): Rep[List[A]]
  def list_prepend[A: Typ](l: Rep[List[A]], e: Rep[A])(implicit
      pos: SourceContext
  ): Rep[List[A]]
  def list_toarray[A: Typ](l: Rep[List[A]])(implicit
      pos: SourceContext
  ): Rep[Array[A]]
  def list_toseq[A: Typ](l: Rep[List[A]])(implicit
      pos: SourceContext
  ): Rep[Seq[A]]
  def list_concat[A: Typ](xs: Rep[List[A]], ys: Rep[List[A]])(implicit
      pos: SourceContext
  ): Rep[List[A]]
  def list_cons[A: Typ](x: Rep[A], xs: Rep[List[A]])(implicit
      pos: SourceContext
  ): Rep[List[A]] // FIXME remove?
  def list_mkString[A: Typ](xs: Rep[List[A]])(implicit
      pos: SourceContext
  ): Rep[String]
  def list_mkString2[A: Typ](xs: Rep[List[A]], sep: Rep[String])(implicit
      pos: SourceContext
  ): Rep[String]
  def list_head[A: Typ](xs: Rep[List[A]])(implicit pos: SourceContext): Rep[A]
  def list_tail[A: Typ](xs: Rep[List[A]])(implicit
      pos: SourceContext
  ): Rep[List[A]]
  def list_isEmpty[A: Typ](xs: Rep[List[A]])(implicit
      pos: SourceContext
  ): Rep[Boolean]
}
...
trait ListOpsExp
  ...
  case class ListMap[A: Typ, B: Typ](
      l: Exp[List[A]],
      x: Sym[A],
      block: Block[B]
  ) extends Def[List[B]]
  case class ListFlatMap[A: Typ, B: Typ](
      l: Exp[List[A]],
      x: Sym[A],
      block: Block[List[B]]
  ) extends Def[List[B]]
  case class ListFilter[A: Typ](
      l: Exp[List[A]],
      x: Sym[A],
      block: Block[Boolean]
  ) extends Def[List[A]]
  case class ListSortBy[A: Typ, B: Typ: Ordering](
      l: Exp[List[A]],
      x: Sym[A],
      block: Block[B]
  ) extends Def[List[A]]
  case class ListPrepend[A: Typ](x: Exp[List[A]], e: Exp[A])
      extends Def[List[A]]
  case class ListToArray[A: Typ](x: Exp[List[A]]) extends Def[Array[A]]
  case class ListToSeq[A: Typ](x: Exp[List[A]]) extends Def[Seq[A]]
  case class ListConcat[A: Typ](xs: Rep[List[A]], ys: Rep[List[A]])
      extends Def[List[A]]
  ...
  case class ListMkString2[A: Typ](l: Exp[List[A]], s: Exp[String])
      extends Def[String]
  ...
  def list_new[A: Typ](xs: Seq[Rep[A]])(implicit pos: SourceContext) = ListNew(
    xs
  )
  def list_fromseq[A: Typ](xs: Rep[Seq[A]])(implicit pos: SourceContext) =
    ListFromSeq(xs)
  def list_map[A: Typ, B: Typ](l: Exp[List[A]], f: Exp[A] => Exp[B])(implicit
      pos: SourceContext
  ) = {
    val a = fresh[A]
  ...
  def list_flatMap[A: Typ, B: Typ](l: Exp[List[A]], f: Exp[A] => Exp[List[B]])(
      implicit pos: SourceContext
  ) = {
    val a = fresh[A]
    val b = reifyEffects(f(a))
  ...
  def list_filter[A: Typ](l: Exp[List[A]], f: Exp[A] => Exp[Boolean])(implicit
      pos: SourceContext
  ) = {
    val a = fresh[A]
    val b = reifyEffects(f(a))
  ...
  def list_toarray[A: Typ](l: Exp[List[A]])(implicit pos: SourceContext) =
    ListToArray(l)
  def list_toseq[A: Typ](l: Exp[List[A]])(implicit pos: SourceContext) =
    ListToSeq(l)
  def list_prepend[A: Typ](l: Exp[List[A]], e: Exp[A])(implicit
      pos: SourceContext
  ) = ListPrepend(l, e)
  def list_concat[A: Typ](xs: Rep[List[A]], ys: Rep[List[A]])(implicit
      pos: SourceContext
  ...
  def list_mkString[A: Typ](l: Exp[List[A]])(implicit pos: SourceContext) =
    ListMkString(l)
  def list_mkString2[A: Typ](l: Rep[List[A]], sep: Rep[String])(implicit
      pos: SourceContext
  ) = ListMkString2(l, sep)
  def list_head[A: Typ](xs: Rep[List[A]])(implicit pos: SourceContext) =
    ListHead(xs)
  def list_tail[A: Typ](xs: Rep[List[A]])(implicit pos: SourceContext) =
    ListTail(xs)
  def list_isEmpty[A: Typ](xs: Rep[List[A]])(implicit pos: SourceContext) =
    ListIsEmpty(xs)
...
trait ListOpsExpOpt extends ListOpsExp {
  override def list_concat[A: Typ](xs1: Exp[List[A]], xs2: Exp[List[A]])(
      implicit pos: SourceContext
  ): Exp[List[A]] = (xs1, xs2) match {
...
trait ScalaGenListOps extends BaseGenListOps with ScalaGenEffect {
  ...
  override def emitNode(sym: Sym[Any], rhs: Def[Any]) = rhs match {
    case ListNew(xs) =>
      emitValDef(sym, src"List(${(xs map { quote }).mkString(",")})")
