...
trait VectorExp extends VectorOps with EffectExp {
  ...
  case class VectorUpdate[T](a: Rep[Vector[T]], x: Rep[Int], y: Rep[T])
      extends Def[Unit]
  case class VectorLength[T](a: Rep[Vector[T]]) extends Def[Int]
  case class VectorPlus(a: Rep[Vector[Double]], b: Rep[Vector[Double]])
      extends Def[Vector[Double]]
  ...
  def vplus(
      a: Rep[Vector[Double]],
      b: Rep[Vector[Double]]
  ): Rep[Vector[Double]] = VectorPlus(a, b)
